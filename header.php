...
<body <?php body_class(); ?>>
    <?php 
        ...
        if ($customerId && $session_customerId == '') {
            ...
            // WC()->session->set('daysLeftPercent', $BQ->get_daysLeftPercent());
            WC()->session->set('carrier', $BQ->get_planId());
            
            WC()->session->set('recert', ($BQ->isUpForRecertification() ) );
     ...
     ?>
        ...
        <div id="page" class="container">
            <header id="header">
                <a class="brand col-lg-2 col-md-2 col-sm-2 col-xs-12" href="http://assistwireless.com" target="_blank">
                    <?=bloginfo('name')?>
                </a>
