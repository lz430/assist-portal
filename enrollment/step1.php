...
<li id="enrollment-step1" class="enrollment-step" style="display:<? echo $isReview ? "none" : "" ?>">
    ...
    <div class="control-group">
        ...
        <div class="controls">
			...
			?>
            <input class="input-block" type="text" name="email" id="email" maxlength="255" value="<?=$email?>"/>
        </div>
    </div>
    ...
    <div id="step1-button-wrapper">
        <input id="step1-submit" onclick="Assist.submitStep1()" type="button" class="enrollment-submit" value="Next"/>
    </div>
