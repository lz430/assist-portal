...
<div class="container">
  <div id="login" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <p id="nav">
        <a href="/lost-password/" title="Password Lost and Found">Lost your password?</a>
    </p>
    <p id="backtoblog"><a href="http://assistwireless.com" title="Are you lost?">← Back to Assist Wireless</a></p>
  </div>
</div>
<script>
