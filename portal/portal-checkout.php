    ...
    <div class="container">
      <form novalidate autocomplete="on" method="POST">
        <div class="form-group">
          <?php echo "Product: " . $BQ->get_sku_description(); ?><br />
          <?php echo "Price  : " . $BQ->get_sku_price(); ?><br />
          <?php echo "Tax    : " . $BQ->get_tax_total(); ?><br />
          <?php echo "<strong>Total</strong>  : " . $BQ->get_total_due(); ?><br />
        </div>
