...
<!-- Banner -->
<img src="<?php echo get_template_directory_uri(); ?>/images/autopay-promo-banner-01.png" alt="Login Promotion">
      ...
      <div class="hide-me">
        ...
        <?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
          <p class="form-row form-row-wide">
            ...
            <input type="password" class="input" name="password" id="reg_password" required/>
          </p>
        <?php endif; ?>
        <!-- Spam Trap -->
...
<?php do_action( 'woocommerce_after_customer_login_form' ); ?>
  ...
  <li>Provide your <strong>date of birth</strong> in this format: MM-DD-YYYY</li>
</ul>
